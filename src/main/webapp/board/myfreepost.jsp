            ...
            <article class="board-area">
                ...
                <table class="board-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>${dto.seq}</td>
                            <td class="title_max"><a href="/mydetail.board?seq=${dto.seq}">${dto.title}</a></td>
                            <td>${dto.writer}</td>
...
// 전 내비 이동
if(needPrev==true){
$(".pagination").append("<a href='/myfreepostlist.board?cpage="+(startNavi-1)+"'><</a>");
}


for(let i = startNavi;i <= endNavi;i++) {
	$(".pagination").append("<a href='/myfreepostlist.board?cpage="+i+"'>"+i+"</a> ");
}

// 후 내비 이동
if(needNext==true){
$(".pagination").append("<a href='/myfreepostlist.board?cpage="+(endNavi+1)+"'>></a>");
}
    </script>
</body>
</html>