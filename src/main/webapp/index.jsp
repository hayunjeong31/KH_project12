...
.best-sellers h2, .new-releases h2 {
...
<body>
	...
	<header>
		<div class="header-container">
			<img src="${pageContext.request.contextPath}/image/GamebitLogo.png"
				alt="Nintendo Logo" class="logo">
			<nav>
				<ul>
					...
					<li><a href="/list.board">게시판</a>
						<div class="dropdown">
							<a href="/list.board">게시판</a> <a href="/list.qboard">Q&A</a> <a
								href="#">공지사항</a>
						</div></li>
					<li><a href="#">마이페이지</a>
						<div class="dropdown">
					...
					<c:when test="${not empty sessionScope.loginID}">
						...
						<div class="btn-container">
							<button class="logout-button"
								onclick="location.href='/logout.members'">Logout</button>
						</div>
					</c:when>
					<c:otherwise>
		...
		<div class="header-container">
			...
			<nav>
				<ul>
					...
					<li><a href="#">마이페이지</a>
						<div class="dropdown">
							<a href="/mypage.members">내 정보 보기</a> <a
								href="/myfreepostlist.board">내가 작성한 게시글</a> <a
								href="/myqpostlist.qboard">내가 작성한 Q&A</a>
						</div></li>
					<li><a href="#">관리자 페이지</a>
						<div class="dropdown">
							<a href="#">대시보드</a> <a href="#">통계</a>
			...
			<div class="header-buttons">
				<c:choose>
					<c:when test="${not empty sessionScope.loginID}">
						<span class="welcome-text-button"
							onclick="location.href='mypage.members'"> <i
							class="fa-solid fa-user"></i>${sessionScope.userName}님 환영합니다
						</span>
						<div class="btn-container">
							<button class="logout-button"
								onclick="location.href='/logout.members'">Logout</button>
					...
					<c:otherwise>
						<button class="login-button"
							onclick="location.href='members/login.jsp'">Login</button>
					</c:otherwise>
				</c:choose>
				<div class="hamburger-menu" onclick="toggleMenu()">
					<div></div>
	...
	<main>
		<div class="banner">
			<div class="slides">
				<img src="image/dung.png" alt="Banner 1" class="active"> <img
					src="image/teraria.jpg" alt="Banner 2"> <img
					src="image/ded.png" alt="Banner 3"> <img
					src="image/skull.png" alt="Banner 4"> <img
					src="image/poke.png" alt="Banner 4">
			</div>
		</div>
	...
	<section class="characters2">
		...
		<div class="zigzag-grid">
			<div class="item game-image">
				<a href="games/gamePage01.jsp"> <img src="image/ded.png"
					alt="게임 이미지" class="img-fluid">
				</a>
			</div>
			...
			<div class="item game-image">
				<a href="games/gamePage02.jsp"> <img src="image/skull2.png"
					alt="게임 이미지" class="img-fluid">
				</a>
			</div>
			<div class="item game-image">
				<a href="games/gamePage03.jsp"> <img src="image/dung.png"
					alt="게임 이미지" class="img-fluid">
				</a>
			</div>
			<div class="item game-description">
			...
			<div class="item game-image">
				<a href="games/gamePage04.jsp"> <img src="image/teraria.jpg"
					alt="게임 이미지" class="img-fluid">
				</a>
			</div>
			<div class="item game-image">
				<a href="games/gamePage05.jsp"> <img src="image/poke2.png"
					alt="게임 이미지" class="img-fluid">
				</a>
			</div>
			<div class="item game-description">
	...
	<footer>
		<div class="footer-content">
			<div class="footer-icons">
				<a href="https://www.facebook.com"><img src="image/face.png"
					alt="Facebook"></a> <a href="https://www.instagram.com"><img
					src="image/insta.png" alt="Instagram"></a> <a
					href="https://www.youtube.com"><img src="image/youtube.png"
					alt="YouTube"></a>
			</div>
